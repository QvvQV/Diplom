...
1. **Поле "Номер карты":**
    * Цифры;
    * Длина значения 19 цифр (принимает 16 цифр).
...
1. **Поле "Номер карты":**
    ...
    * Длина значения равна 19 цифрам;
...
1. **Поле "Год":**
    * Поле пустое;
    * Состоит из одной цифры;
    * Значение меньше текущего года (менее 24);
    * Значение на 5+ лет больше текущего года (более 30);
    * Значение равно 00.
...
1. Написание кода тестов - 50-80 часов 
